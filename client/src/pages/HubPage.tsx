...
export function HubPage() {
  ...
  </div><AlertDialog open={Boolean(pendingRemoval)} onOpenChange={open => { if (!open) setPendingRemoval(null); }}><AlertDialogContent><AlertDialogHeader><AlertDialogTitle>Remove this item?</AlertDialogTitle><AlertDialogDescription>{pendingRemoval ? `“${pendingRemoval.title}” will be removed from this browser. This cannot remove any browser-local copies already held by approved peers.` : ""}</AlertDialogDescription></AlertDialogHeader><AlertDialogFooter><AlertDialogCancel>Keep it</AlertDialogCancel><AlertDialogAction onClick={confirmRemoval}>Remove from this browser</AlertDialogAction></AlertDialogFooter></AlertDialogContent></AlertDialog></AppFrame></ProfileGate>;
}
