...
import { Bold, Code2, Heading1, Heading2, Italic, List, ListOrdered, Quote, Redo2, Strikethrough, Undo2 } from "lucide-react";
...
export function CollaborativeEditor({ ydoc, provider, profile, onReady }: { ydoc: Y.Doc; provider?: WebrtcProvider; profile: LocalProfile; onReady: (editor: Editor) => void }) {
  ...
  return <div className="overflow-hidden rounded-2xl border border-white/[0.1] bg-[#111722]/88 shadow-[0_20px_70px_rgba(0,0,0,0.18)]"><EditorToolbar editor={editor} /><EditorContent editor={editor} /></div>;
}
