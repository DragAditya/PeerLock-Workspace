...
export function AppFrame({ children }: { children: React.ReactNode }) {
  const [location, navigate] = useLocation(); const { profile, createDocument } = useWorkspace(); const account = trpc.auth.account.useQuery(undefined, { retry: false }); const [commandOpen, setCommandOpen] = useState(false); const studioRoute = location.startsWith("/studio/");
