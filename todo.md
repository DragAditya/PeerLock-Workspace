...
- [x] Create a continuous, reduced-motion-safe handshake-to-room-entry transition that expands the verified room-access state into the entry form without an abrupt page swap or change to access-control logic.
- [x] Refine the secure room-access handoff into a slower premium shared-element sequence with softer easing and visible visual continuity.
